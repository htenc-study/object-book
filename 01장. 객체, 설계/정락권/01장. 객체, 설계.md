...
![너무_많은_클래스에_의존하는_Theater.png](너무_많은_클래스에_의존하는_Theater.png)
...
![자율적인_Audience와_TickerSellder로_구성된_설계.png](자율적인_Audience와_TickerSellder로_구성된_설계.png)
...
![책임이_중앙집중된_절차적_프로그래밍.png](책임이_중앙집중된_절차적_프로그래밍.png)

Theater에 모든 책임이 집중되어 있어 변경에 취약합니다.

**객체지향 프로그래밍 (After):**

![책임이_분산된_객체지향_프로그래밍.png](책임이_분산된_객체지향_프로그래밍.png)

각 객체가 자신의 책임을 갖고 협력하여 변경에 유연합니다.
